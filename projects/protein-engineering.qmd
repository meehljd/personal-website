...
This project was my practicum for my master's degree in analytics at Georgia Tech, where I applied my data science skills to the field of protein engineering.  You can view the full technical report [here](/files/Practicum_Final_Report.pdf).
...
![The 3 main steps in my computational pipeline.](/images/projects/pe/comp_workflow.png){width=100% max-width=650px .lightbox}
...
![Correlation between actual and predicted functional rank of zero-shot predictions for an example protein.](/images/projects/pe/rank_correlation_AMIE_PSEAE_Whitehead.png){width=65% max-width=450 .lightbox}
...
![Number of rounds to get top variants in DMS dataset of zero-shot predictions for an example protein.](/images/projects/pe/fitness_landscape_AMIE_PSEAE_Whitehead.png){width=65% max-width=450 .lightbox}
...
![Number of rounds to get top variants in DMS dataset of few-shot regression algorithms for an example protein.](/images/projects/pe/regression_best_train_hist.png){width=65% max-width=450 .lightbox}
...
![GP prediction performance as data draining size increases](/images/projects/pe/gauss_best_train_hist.png){width=65% max-width=450 .lightbox}
...
![Number of rounds to get top variants in DMS dataset for an example protein using BO](/images/projects/pe/bo_fitness_landscape_AMIE_PSEAE_Whitehead.png){width=65% max-width=450 .lightbox}
...
For those who want to dive deeper into the nitty-gritty details, here is the [Practicum Final Report](/files/Practicum_Final_Report.pdf). It includes all the mathematical formulas, model architectures, and performance metrics for a comprehensive understanding of the project.
