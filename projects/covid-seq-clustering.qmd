...
![Histogram of the entropy per MSA position.  The left mode is random mutations and the other modes are mutations of major strains.](/images/projects/csc/entropy.png){width=params.img_width max-width=params.img_max_width .lightbox}
...
![Visualization of MSA sequences after trimming.  Color scale based on A (lightest), C, G, T (darkest).](/images/projects/csc/sequences_trim.png){width=25% max-width=150px .lightbox}
...
![$k$=1](/images/projects/csc/sequences_sorted_1.png){#fig-adj1 max-with=150px .lightbox}

![$k$=5](/images/projects/csc/sequences_sorted_5.png){#fig-adj5 max-with=150px .lightbox}

![$k$=7](/images/projects/csc/sequences_sorted_7.png){#fig-adj7 max-with=150px .lightbox}

![$k$=9](/images/projects/csc/sequences_sorted_9.png){#fig-adj9 max-with=150px .lightbox}
...
![$k$=1](/images/projects/csc/sequences_sorted_iso_1.png){#fig-adj1 max-with=150px .lightbox}

![$k$=5](/images/projects/csc/sequences_sorted_iso_5.png){#fig-adj5 max-with=150px .lightbox}

![$k$=7](/images/projects/csc/sequences_sorted_iso_7.png){#fig-adj7 max-with=150px .lightbox}

![$k$=9](/images/projects/csc/sequences_sorted_iso_9.png){#fig-adj9 max-with=150px .lightbox}
